...
class YOLOv8_face:
    ...
    def detect(self, srcimg):
        ...
        det_bboxes, det_conf, det_classid, landmarks = self.post_process(outputs[0], scale_h, scale_w, padh, padw)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--modelpath', type=str, default='weights/yolov8-lite-t_new.onnx',
                        help="onnx filepath")
